...
bash /content/data/conll-2012/v3/scripts/skeleton2conll.sh -D $ontonotes_path/data/files/data $data_dir/conll-2012
...
python preprocess.py --input_dir $data_dir --output_dir $data_dir --seg_len 512
 -D $ontonotes_path/data/files/data $data_dir/conll-2012
